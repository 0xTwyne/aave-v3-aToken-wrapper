...
/**
 * @title CustomERC4626StataTokenUpgradeable
 * @notice Custom version of ERC4626StataTokenUpgradeable with unlimited max functions
 * @dev Modified to return type(uint256).max for maxDeposit, maxMint, maxWithdraw, maxRedeem
 */
abstract contract CustomERC4626StataTokenUpgradeable is ERC4626Upgradeable, IERC4626StataToken {
  ...
  ///@inheritdoc IERC4626
  /// @dev Modified to return unlimited minting
  function maxMint(address) public pure override returns (uint256) {
    return type(uint256).max;
  }

  ///@inheritdoc IERC4626
  /// @dev Modified to return unlimited withdrawals
  ...
  ///@inheritdoc IERC4626
  /// @dev Modified to return unlimited redemptions
  function maxRedeem(address) public pure override returns (uint256) {
    return type(uint256).max;
  }

  ///@inheritdoc IERC4626
  /// @dev Modified to return unlimited deposits
